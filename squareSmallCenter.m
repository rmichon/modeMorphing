...
impulseName = 'wav/squareSmallCenterImp.wav';
respName = 'wav/squareSmallCenterResp.wav';
...
%index = [3 4 5 6 9 10 11 12 15 16 17 18 19 22 24 25 27 28 29 32 33 34 35 36 41 43 45 46 47 48 50 52 53 54];
%index = [3 6 9 12 19 27 43];
% index = [3 5 9 12 15 19 21 27];
index = [3 5 8 12 14 15 17 18];
%index = [3 4 5 6 7 8 15 19];
nmode = length(index);
fm = fm(index);
gammam = gammam(index);
%#of modes: 34
...
fileFreq = fopen('modes/squareSmallCenterFreq.txt','w');
fileGain = fopen('modes/squareSmallCenterGain.txt','w');
fileT60 = fopen('modes/squareSmallCenterT60.txt','w');
